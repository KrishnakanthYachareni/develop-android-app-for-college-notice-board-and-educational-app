...
<html>
<head>
<title>Jntuh Manthani Notification Board</title>
...
<div class="container">
	...
	<center><img src="images/ic.png" height="" width="60" width="60" border="10">
		...
		<h1>JNTUH Manthani Notice Board</h1><hr/>
...
<form action="notifyexecdelete.php" method="post">
		<h1>To Delete Previous Notices</h1><hr/>
		<p>Choose Delete The Notice</p>
		<select name="position" class="ed">
			<option value="student">Student</option>
