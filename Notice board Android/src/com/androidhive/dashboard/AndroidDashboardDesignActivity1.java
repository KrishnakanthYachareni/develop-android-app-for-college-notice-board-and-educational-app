...
public class AndroidDashboardDesignActivity1 extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        btn_newsfeed.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				Intent i = new Intent(getApplicationContext(), JntuMaterial.class);
				startActivity(i);
			}
		});
       ...
       // Listening Friends button click
        btn_friends.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				// Launching News Feed Screen
				Intent i = new Intent(getApplicationContext(), Webtechnology.class);
				startActivity(i);
			}
		});
        ...
        btn_events.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				// Launching News Feed Screen
				Intent i = new Intent(getApplicationContext(), Placements.class);
				startActivity(i);
			}
		});
